...
const StickyCTA: React.FC<StickyCTAProps> = () => {
    return (
        <div className="w-full bg-white/95 backdrop-blur-xl border-t border-gray-100 py-3 px-4 shadow-2xl">
            <div className="max-w-4xl mx-auto flex flex-row items-center justify-between gap-3 md:gap-6">
                {/* Left: Connect on Call */}
                <a
                    href={`tel:+61${siteConfig.contact.phones[0].replace(/[^0-9]/g, '')}`}
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <span className="text-[8px] md:text-[10px] font-black text-[#29b8bd] uppercase tracking-wider leading-none mb-0.5 whitespace-nowrap">Let's Talk</span>
