...
const ReviewCard = ({ review }: { review: any }) => {
    ...
    return (
        <TiltCard className="review-card-item-wrapper">
            <div className="review-card-item group">
                ...
                <div className="flex items-center justify-between mt-auto pt-4">
                    <div className="flex text-[#fabb05] gap-0.5" style={{ transform: "translateZ(30px)" }}>
                        {[...Array(5)].map((_, i) => (
                    ...
                    <div className="w-7 h-7" style={{ transform: "translateZ(40px)" }}>
